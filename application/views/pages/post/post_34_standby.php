          ...
          <div class="box-header with-border">
            <div class="row">
              ...
              <div class="col-xs-6 text-right">
                 <a href="<?php echo base_url('Dash/post_34_standby/standby');?>" class="btn btn-primary">Standby</a>
                  <a href="<?php echo base_url('Dash/post_34_standby/l');?>" class="btn btn-warning">Operation</a>
                  <a href="<?php echo base_url('Dash/post_34_standby/');?>" class="btn btn-info">All</a>
              </div>
            </div>
          </div>
