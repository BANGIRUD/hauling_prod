                    ...
                    foreach ($data as $value) {
                      ...
                      $color = explode(',', $value['color']);
                        ...
                        echo '
                              ...
                              <td>'. date('Y-m-d H:i',strtotime($value['time_in'])).'</td>';
                        echo '<td nowrap>';
...
<div class="modal fade" id="modal-addunit" role="dialog"  aria-hidden="true" tabindex="-1"><!-- Modal Edit Unit -->
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <form action="<?= base_url('Save/add_unit_scale');?>" method="post" enctype="multipart/form-data" class="form-horizontal">
...
<div class="modal fade" id="modal-edit" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form action="<?= base_url('Edit/edit_shift_operation_scale');?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
...
<script type="text/javascript">
  ...
  $(document).on('click','#edit', function() {
    var id = $(this).attr('data-id');
      $("#modal-body-edit").load("<?= base_url('View/edit/shift_operations_scale/');?>" + id);
