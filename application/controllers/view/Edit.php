			                  	...
			                  	<label>Date Out</label> 
			                  		<div class="input-group date">
				                    	<div class="input-group-addon">
					                    	...
					                    	<input type="date" style="background-color: #e9ecef; padding: 0;" class="form-control pull-right datepicker" name="date_out" value="<?= date('Y-m-d', strtotime($data->time_out)) ;?>">
				                  	</div>
		                	</div>
		                	<div class="col-xs-4">
